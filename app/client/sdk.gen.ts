...
import type { OfferGetLegalRolesData, OfferGetLegalRolesResponses, OfferListOffersData, OfferListOffersResponses, OfferListOffersErrors, OfferCreateOfferData, OfferCreateOfferResponses, OfferCreateOfferErrors, OfferGetOfferByIdData, OfferGetOfferByIdResponses, OfferGetOfferByIdErrors, OfferUpdateOfferData, OfferUpdateOfferResponses, OfferUpdateOfferErrors, OfferGetSimilarOffersByUserData, OfferGetSimilarOffersByUserResponses, OfferGetSimilarOffersByUserErrors, OfferListRawOffersData, OfferListRawOffersResponses, OfferListRawOffersErrors, OfferCreateRawOfferData, OfferCreateRawOfferResponses, OfferCreateRawOfferErrors, OfferImportRawOffersData, OfferImportRawOffersResponses, OfferImportRawOffersErrors, OfferGetRawOfferData, OfferGetRawOfferResponses, OfferGetRawOfferErrors, OfferParseRawOfferData, OfferParseRawOfferResponses, OfferParseRawOfferErrors, OfferAcceptOfferData, OfferAcceptOfferResponses, OfferAcceptOfferErrors, OfferRejectOfferData, OfferRejectOfferResponses, OfferRejectOfferErrors, PlaceCreatePlaceData, PlaceCreatePlaceResponses, PlaceCreatePlaceErrors, PlaceCreateCityData, PlaceCreateCityResponses, PlaceCreateCityErrors, PlaceGetFacilitiesData, PlaceGetFacilitiesResponses, PlaceGetFacilitiesErrors, PlaceGetFacilityData, PlaceGetFacilityResponses, PlaceGetFacilityErrors, PlaceGetCityData, PlaceGetCityResponses, PlaceGetCityErrors, PlaceGetCitiesData, PlaceGetCitiesResponses, PlaceGetCitiesErrors, DefaultReadRootData, DefaultReadRootResponses, DefaultSreadRootData, DefaultSreadRootResponses, HealthcheckHealthCheckData, HealthcheckHealthCheckResponses } from './types.gen';
 ...
 * Sread Root
 */
export const defaultSreadRoot = <ThrowOnError extends boolean = false>(options?: Options<DefaultSreadRootData, ThrowOnError>) => {
    return (options?.client ?? client).get<DefaultSreadRootResponses, unknown, ThrowOnError>({
        responseType: 'json',
        url: '/s',
        ...options
    });
