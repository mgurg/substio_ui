...
export const getReviewOfferOffersOfferUuidGet = <ThrowOnError extends boolean = false>(options: Options<GetReviewOfferOffersOfferUuidGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetReviewOfferOffersOfferUuidGetResponses, GetReviewOfferOffersOfferUuidGetErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
...
export const rejectOfferOffersRejectOfferUuidPatch = <ThrowOnError extends boolean = false>(options: Options<RejectOfferOffersRejectOfferUuidPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<RejectOfferOffersRejectOfferUuidPatchResponses, RejectOfferOffersRejectOfferUuidPatchErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
...
export const getFacilityPlacesFacilityUuidPlaceUuidGet = <ThrowOnError extends boolean = false>(options: Options<GetFacilityPlacesFacilityUuidPlaceUuidGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetFacilityPlacesFacilityUuidPlaceUuidGetResponses, GetFacilityPlacesFacilityUuidPlaceUuidGetErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
...
export const getCityPlacesCityUuidCityUuidGet = <ThrowOnError extends boolean = false>(options: Options<GetCityPlacesCityUuidCityUuidGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCityPlacesCityUuidCityUuidGetResponses, GetCityPlacesCityUuidCityUuidGetErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
