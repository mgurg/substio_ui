...
export const acceptOfferOffersAcceptOfferUuidPatch = <ThrowOnError extends boolean = false>(options: Options<AcceptOfferOffersAcceptOfferUuidPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<AcceptOfferOffersAcceptOfferUuidPatchResponses, AcceptOfferOffersAcceptOfferUuidPatchErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
