...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://subaro.sentry.io/issues/?project=4509920514539600">Issues Page</a>.
